...
import com.malluos.settings.utils.HttpHandler;
...
public class MalluOSDevsInfoFragment extends SettingsPreferenceFragment {

    @Override
    public void onCreate(Bundle savedInstanceState) {
       super.onCreate(savedInstanceState);

        addPreferencesFromResource(R.xml.malluos_devs_info);
		showGitProfileIcons();
    }
	...
	private void showGitProfileIcons() {
		...
		getGithubIcon(R.string.mentions1_git, findPreference("mentions1"));
	}
